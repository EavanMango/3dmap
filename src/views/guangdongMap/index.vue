<template>
  <div class="large-screen">
    ...
    <div class="large-screen-wrap" id="large-screen">
      <m-header
        title="广东省数据可视化平台"
        sub-text="Guangdong Province Data Visualization Platform"
        v-show="true"
      >
        <!--左侧 天气 -->
        ...
        <template v-slot:right>
          <div class="m-header-date">
            <span>2024-10-12</span><span>17:53:16</span>
          </div></template
        >
      </m-header>
      <!-- 顶部菜单 -->
      <div class="top-menu" v-show="true">
      ...
      <div class="bottom-tray">
        ...
        <div class="bottom-menu">
          <div
            ...
            :class="{ 'is-active': state.bottomMenuStatus.bar }"
          ...
          <div
            class="bottom-menu-item"
            :class="{ 'is-active': state.bottomMenuStatus.point }"
          ...
          <div
            class="bottom-menu-item"
            :class="{ 'is-active': state.bottomMenuStatus.path }"
          ...
          <div
            class="bottom-menu-item"
            :class="{ 'is-active': state.bottomMenuStatus.hotmap }"
...
import provincesData from "./map/provincesData.js";
...
// 创建柱状图
function createBar() {
  let data = provincesData.filter((item, index) => index < 7);
